angular.module('cpApp.ctrl.upfile', ['ui.bootstrap', 'xeditable', 'textAngular', 'angularSpinner'])
    .controller('uploadFileCtrl', function ($scope, $http, $filter) {
        ...
        $scope.saveLabFiles = function (id) {
            ...
            if ($scope.user.IsStudent && ( $scope.editFileSend.Comments == null || $scope.editFileSend.Comments.length == 0 || JSON.parse($scope.getLecturesFileAttachments()).length == 0)) {
