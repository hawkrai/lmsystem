...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Показаны все {0}',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'Показаны все',                                                        // when there are no options present in the list
